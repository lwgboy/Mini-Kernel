...
public class ImageCondition extends SpringBootCondition{

	@Override
	public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata metadata) {
		// TODO Auto-generated method stub
		//String kvmServicePkg="com.gcloud.compute.service.kvm";
		Map<String, Object> attributes = metadata.getAnnotationAttributes(ConditionalImage.class.getName());
		if(attributes==null)
			return ConditionOutcome.noMatch("");
		PropertyResolver resolver=context.getEnvironment();
		String hypervisorConfig =resolver.getProperty("gcloud.controller.component.image");
