...
public class SlbCondition extends SpringBootCondition {
	...
	public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata metadata) {
		...
		Map<String, Object> attributes = metadata
				.getAnnotationAttributes(ConditionalSlb.class.getName());
		if(attributes==null)
			return ConditionOutcome.noMatch("");
		PropertyResolver resolver=context.getEnvironment();
		String hypervisorConfig =resolver.getProperty("gcloud.controller.component.slb");
