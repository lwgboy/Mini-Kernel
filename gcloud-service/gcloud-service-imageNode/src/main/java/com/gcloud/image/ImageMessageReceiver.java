...
public class ImageMessageReceiver {
    ...
    @RabbitListener(queues = "${gcloud.service.imageNode}")
    @RabbitHandler
        ...
        try {
            ...
            if(message instanceof NeedReplyMessage){
                ...
                if(replyClass != null && ReplyMessage.class.isAssignableFrom(replyClass)){
                    ...
                    try{
                        String errorMsg = "image_node_error::system error";
                        ...
                        log.error("reply image error", nex);
                    }
                }
            }
        }
    ...
    @RabbitListener(queues = "${gcloud.service.imageNode}" + "_async")
    @RabbitHandler
