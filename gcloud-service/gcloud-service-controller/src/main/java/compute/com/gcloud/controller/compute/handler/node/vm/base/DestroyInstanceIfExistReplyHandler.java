...
import com.gcloud.header.compute.msg.node.vm.base.DestroyInstanceIfExistReplyMsg;
...
@Handler
@Slf4j
public class DestroyInstanceIfExistReplyHandler extends AsyncMessageHandler<DestroyInstanceIfExistReplyMsg>{
	...
	@Override
	public void handle(DestroyInstanceIfExistReplyMsg msg) {
