...
-- 租户用户sql修改    2019-06-17

DROP TABLE IF EXISTS `gc_user`;
DROP TABLE IF EXISTS `gc_domain`;
DROP TABLE IF EXISTS `gc_endpoint`;
...
INSERT INTO `gc_roles` (`id`, `name`, `create_time`, `creator`, `description`, `role_type`) VALUES ('ordinary', '普通用户', '2019-6-14 11:19:08', 'admin', '不可修改与删除', 0);
...
INSERT INTO `gc_roles` (`id`, `name`, `create_time`, `creator`, `description`, `role_type`) VALUES ('tenantadmin', '租户管理员', '2019-6-14 11:19:55', 'admin', '不可修改与删除', 0);


-- 添加用户租户初始化数据 2019-06-18
INSERT INTO `gc_users` (`id`, `login_name`, `password`, `access_key`, `secret_key`, `gender`, `email`, `mobile`, `role_id`, `disable`, `create_time`, `creater`, `real_name`, `login_count`, `online`, `last_login_time`, `locked`, `lock_start_time`, `parent_id`) 
VALUES ('dd81efe719bf4b05a3c21524ccf6c2qq', 'tenantAdmin', '6e539d81a81b91740b22b07733bd6171', 'dd81efe719bf4b05a3c21524ccf6c2qq', 'weqdsMaQAns9ki6SFlHps212flgY4TcPpQRrit0F', '1', 'gcloudtest@qq.com', '18955555555', 'domainadmin', '0', '2019-06-14 11:15:24', 'admin', '租户管理员', '0', '0', NULL, '0', NULL, NULL);
...
ALTER TABLE `gc_users` DROP `parent_id`;
TRUNCATE TABLE `gc_roles`;
