...
public class RSAUtils {
    ...
    public static final String PRIVATE_KEY_DAT = "rsa_private_key.dat";
    
    public static final String PUBLIC_KEY_DAT = "rsa_public_key.dat";
    ...
    public static byte[] decryptByPublicKey(byte[] encryptedData, String publicKey)
            throws Exception {
        byte[] keyBytes = Base64.decodeBase64(publicKey);//Base64Utils.decode(publicKey);
