...
public class ZipUtil {  
    ...
    public void zip(String src, String dest, List<String> filter) throws Exception {  
    ...
    public void zip(ZipOutputStream out, File srcFile, String base, List<String> filter) throws Exception {  
    ...
    public static void main(String[] args) throws Exception {  
		...
		String dest="D:\\test112/";
		zu.unZip(srcFile, dest, deleteFile);
    }  
}  
